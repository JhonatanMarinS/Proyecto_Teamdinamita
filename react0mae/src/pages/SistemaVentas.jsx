                ...
                <fieldset>
                    ...
                    <form name="form_new_cliente_venta" id="form_new_cliente_venta" className="datos">
                        ...
                        <div className="wd30">
                            ...
                            <input type="text" name="Direccion_cliente" id="Direccion_cliente" styles="padding-right: 342px;"/>
                        </div>
                    ...
                    <table  className="tbl_venta">
                        <thead>
                            <tr className="tr">
                                ...
                                <th styles="width: 75px;">Accion</th>
                            </tr>
                            <tr className="tr">
                                <td><input type="text" name="txt_cod_producto" id="txt_cod_producto" styles="height: 21xp; width: 58px;"/></td>
                                <td><input type="text" name="txt_descripcion" id="txt_descripcion" styles="height:21xp; width: 116xp;"/></td>
                                <td><input type="text" name="txt_existencia" id="txt_existencia" styles="width: 85px;"/></td>
                                <td><input type="text" name="txt_cod_producto" id="txt_cod_producto" styles="width: 80px;"value="0" min="1" /></td>
